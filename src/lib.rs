//! airtouch5-webui: a small web server wrapping the [`airtouch5`] crate.
//!
...
//!   contract, for e2e tests and the `airtouch5-webui-mock` binary (manual UI dev
//!   without a console).
...
//!
//! The two binaries (`airtouch5-webui`, real; `airtouch5-webui-mock`, mock) are thin entrypoints
